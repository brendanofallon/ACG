...
public class SpinArrow extends JPanel implements MouseListener, ActionListener {
	...
	private void initializeImages() {
		closedHighlight = UIConstants.getIcon("gui/icons/triangle_highlight.png").getImage();
		one = UIConstants.getIcon("gui/icons/triangle_1.png");
		two = UIConstants.getIcon("gui/icons/triangle_2.png");
		three = UIConstants.getIcon("gui/icons/triangle_3.png");
		four = UIConstants.getIcon("gui/icons/triangle_4.png");
		five = UIConstants.getIcon("gui/icons/triangle_5.png");
		six = UIConstants.getIcon("gui/icons/triangle_highlight6.png");
		...
		openHighlight = UIConstants.getIcon("gui/icons/triangle_highlight6.png").getImage();
		initialized = true;
	}
